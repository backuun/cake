<?php include 'template/header.php' ?>
    <div class="text-center py-md-13 rounded-5 m-4 banner-height" style="background-image:url(images/bg_store.png); background-repeat:no-repeat; background-size:cover; background-position:center;">
        
    </div>
    <div class="px-3 pt-5 px-md-3 py-3 py-md-0 mt-5">
        <div class="col mt-4 px-5 d-flex justify-content-center w-100">
            <div class="row row-cols-2 pb-5 row-cols-xl-3 row-cols-lg-2 w-100 px-5 mx-xl-5 mx-lg-0">
                    ...
                    <div class="text-center border border-1 rounded-5 overflow-hidden" style="border-color: #A99685 !important;">
                        ...
                        <div class="p-4 pb-3">
                            <ul class="text-start list-group list-group-flush p-0 m-0">
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2">
                                    ...
                                    <div class="col">
                                        ...
                                        Jl. Pantai Indah Kapuk Boulevard, Jakarta Utara</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="text-start list-group list-group-flush p-0 m-0">
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <p class="poppins fs-6 grey-color">Jl. Gunawarman No.18, Kebayoran Baru, Jakarta</p>
                                    </div>
                                </li>
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 pt-3">
