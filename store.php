<?php include 'template/header.php' ?>
    <div class="text-center py-md-13  banner-height" style="background-image:url(images/bg_store.png); background-repeat:no-repeat; background-size:cover; background-position:center;">
        
    </div>
    <div class="text-start p-4 pb-0 px-4 px-md-5 px-lg-5">
        <p class="poppins fs-6" style="color:#1b1b1b98;">Home / <span class="fw-semibold grey-color">Stores</span></p>
    </div>
    <div class="text-center mt-5 mt-md-5 mt-lg-5 mt-xl-5">
        <h1 class="font-primary fw-bold grey-color fs-05 text-uppercase">Stores</h1>
    </div>
    <div class="px-1 pt-0 pt-md-0 px-md-3 py-3 py-md-0 mt-2 bg-container">
        <div class="col mt-4 px-0 px-md-2 d-flex justify-content-center w-100">
            <div class="row row-cols-1 row-cols-md-2 pb-5 row-cols-xl-3 row-cols-lg-2 w-100 px-1 px-md-0 px-lg-2 mx-xl-5 mx-lg-0">
                <div class="p-xl-3 p-lg-3 p-md-3 p-3">
                    <div class="text-center border border-1 rounded-5 overflow-hidden" style="border-color: #A99685 !important;">
                        <div class="p-0 image-card-custom-store">
                        ...
                        <div class="p-4 pb-3 bg-light height_store_custom">
                            <ul class="text-start list-group list-group-flush p-0 m-0">
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 bg-light">
                                    ...
                                    <div class="col">
                                        <h3 class="poppins fs-4 grey-color text-uppercase">Pantai Indah Kapuk</h3>
                                        <p class="poppins fs-6 grey-color">PIK Avenue Mall, Lt. 1F / IB – 8,
                                        Jl. PIK Boulevard, Jakarta Utara</p>
                                    </div>
                                </li>
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 pt-3 bg-light">
                                    <iconify-icon icon="ic:baseline-phone" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <p class="poppins fs-6 grey-color">+6221 5011 6411</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="p-4 pb-3 bg-light height_store_custom">
                            <ul class="text-start list-group list-group-flush p-0 m-0 bg-transparent">
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 bg-light">
                                    <iconify-icon icon="fluent:location-28-filled" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <h3 class="poppins fs-4 grey-color text-uppercase">Gunawarman</h3>
                                        <p class="poppins fs-6 grey-color">Jl. Gunawarman No. 18, Senopati, Kebayoran Baru, Jakarta Selatan</p>
                                    </div>
                                </li>
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 pt-3 bg-light">
                                    <iconify-icon icon="mage:whatsapp-filled" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <p class="poppins fs-6 grey-color">+62817 4918 867</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="p-4 pb-3 bg-light height_store_custom">
                            <ul class="text-start list-group list-group-flush p-0 m-0">
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 bg-light">
                                    <iconify-icon icon="fluent:location-28-filled" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <h3 class="poppins fs-4 grey-color text-uppercase">Menteng</h3>
                                        <p class="poppins fs-6 grey-color">Jl. HOS Cokroaminoto 42A, Menteng, Jakarta</p>
                                    </div>
                                </li>
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 pt-3 bg-light">
                                    <iconify-icon icon="ic:baseline-phone" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <p class="poppins fs-6 grey-color">+6221 316 1413</p>
                                    </div>
                                </li>
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 pt-3 bg-light">
                                    <iconify-icon icon="mage:whatsapp-filled" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <p class="poppins fs-6 grey-color">+62818 669 009</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="p-4 pb-3 bg-light height_store_custom">
                            <ul class="text-start list-group list-group-flush p-0 m-0">
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 bg-light">
                                    <iconify-icon icon="fluent:location-28-filled" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <h3 class="poppins fs-4 grey-color text-uppercase">Gading Serpong</h3>
                                        <p class="poppins fs-6 grey-color">Jl. Gading Serpong Boulevard, Blok M5, No. 28A,
                                        Kec. Klp Dua, Tangerang, Banten</p>
                                    </div>
                                </li>
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 pt-3 bg-light">
                                    <iconify-icon icon="ic:baseline-phone" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <p class="poppins fs-6 grey-color">+6221 5999 2237</p>
                                    </div>
                                </li>
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 pt-3 bg-light">
                                    <iconify-icon icon="mage:whatsapp-filled" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <p class="poppins fs-6 grey-color">+62817 4918 880</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="p-4 pb-3 bg-light height_store_custom">
                            <ul class="text-start list-group list-group-flush p-0 m-0">
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 bg-light">
                                    <iconify-icon icon="fluent:location-28-filled" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <h3 class="poppins fs-4 grey-color text-uppercase">Kelapa Gading</h3>
                                        <p class="poppins fs-6 grey-color">Jl. Boulevard Raya WB2 No.24, Kelapa Gading Permai, Jakarta</p>
                                    </div>
                                </li>
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 pt-3 bg-light">
                                    <iconify-icon icon="ic:baseline-phone" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <p class="poppins fs-6 grey-color">+6221 4585 6951</p>
                                    </div>
                                </li>
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 pt-3 bg-light">
                                    <iconify-icon icon="mage:whatsapp-filled" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <p class="poppins fs-6 grey-color">+62817 4918 870</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="p-4 pb-3 bg-light height_store_custom">
                            <ul class="text-start list-group list-group-flush p-0 m-0 bg-transparent">
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 bg-transparent">
                                    <iconify-icon icon="fluent:location-28-filled" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <h3 class="poppins fs-4 grey-color text-uppercase">Delivery & Pick Up</h3>
                                        <p class="poppins fs-6 grey-color">Central Kitchen JL. Gunung Sahari III NO.5 & 5A, Gn. Sahari Selatan, Jakarta</p>
                                    </div>
                                </li>
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 pt-3 bg-transparent">
                                    <iconify-icon icon="ic:baseline-phone" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <p class="poppins fs-6 grey-color">+6221 425 5851</p>
                                    </div>
                                </li>
                                <li class="list-group-item p-0 d-flex justify-content-start align-items-start gap-2 pt-3 bg-transparent">
                                    <iconify-icon icon="mage:whatsapp-filled" class="fs-4 grey-color"></iconify-icon>
                                    <div class="col">
                                        <p class="poppins fs-6 grey-color">+62878 8443 7090</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
