        ...
        <div class="col-5 px-4">
            ...
            <div class="col rounded-4 p-4" style="background-color: #F2F4F7;">
                ...
                <div class="row px-1 mt-1 mb-4">
                    <div class="col-8">
                        <input type="text" class="w-100 fs-5 poppins px-2 outline-none border border-1 rounded-pill p-2 px-3" style="border-color: #604A33 !important; color: #604A33 !important;">
                    </div>
                    <div class="col-4">
                        <button class="w-100 fs-5 poppins outline-none border border-1 rounded-pill p-2 text-light" style="background-color: #604A33 !important;">Apply Coupon</button>
                    </div>
                </div>
                <div class="d-flex w-100 mt-3 justify-content-between align-items-center border-bottom border-1 pb-3" style="border-color: #604A33 !important;">
                    <span class="poppins fs-5 fw-semibold" style="color: #604A33;">Tax included, shipping calculated at checkout.</span>
                </div>
                <div class="d-flex border-bottom border-1 py-4 w-100" style="border-color: #604A33 !important;">
                    <div class="col-5">
                        <h3 class="fw-bold poppins fs-2" style="color: #604A33;">Subtotal</h3>
                    </div>
                    <div class="col-7 text-end">
                        <h1 class="fw-bold poppins fs-1" style="color: #604A33;">Rp. 1.500.000,-</h1>
                    </div>
                </div>
                <div class="col mt-3">
                    <h5 class="poppins mb-3 fs-5 fw-semibold" style="color: #604A33;">Delivery</h5>
                    <div class="row">
                        <div class="col">
                ...
                <div class="col mt-4">
                    <h5 class="poppins mb-4 fs-5 fw-semibold" style="color: #604A33;">Select your preferred date and time for delivery:</h5>
                    <div class="col">
                        <div class="col d-flex align-items-center gap-3 border rounded-4 border-1 bg-light py-3 px-4 mb-4" style="border-color: #604A33 !important;">
                            <iconify-icon for="dateInput" icon="fa:calendar" class="fs-4"></iconify-icon>
                            <input type="date" class="w-100 poppins bg-transparent border-0 outline-none fs-5">
                        </div>
                        <div class="col d-flex align-items-center gap-3 border rounded-4 border-1 bg-light py-3 px-4" style="border-color: #604A33 !important;">
                            <iconify-icon icon="bytesize:clock" class="fs-4"></iconify-icon>
                            <select id="time-range" class="w-100 poppins fs-5 border-0 outline-none bg-transparent">
                ...
                <div class="col mt-4">
                    <h5 class="poppins mb-4 fs-5 fw-semibold" style="color: #604A33;">Please enter delivery instructions (optional) :</h5>
                    <div class="col">
                        <textarea class="height-input-custom rounded-4 w-100 outline-none border-1 px-3 py-3 poppins" style="resize: none; border-color: #604A33 !important;"></textarea>
                    </div>
                </div>
