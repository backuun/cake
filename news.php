...
<div class="col">
    ...
    <div class="container-xl py-3 pb-2" style="position:relative;">
        <!-- <img src="images/circle_right.svg" class="img-decoration-right"/> -->
        <h1 class="font-primary grey-color fs-05 ms-3">Latest News</h1>
        <div class="row row-cols-2 pb-5 row-cols-lg-2 m-auto row-cols-xl-3 w-100">
                ...
                <div class="p-4">
                    <div class="row flex-column border border-1 rounded-5" style="border-color: #A99685 !important;">
                        ...
                        <div class="col p-4 py-2 pb-4 bg-light rounded-5">
                            ...
                            <a href="detail-news.php"><button class="poppins fs-5 outline-none border-0 px-5 py-2 mt-3 text-light rounded-pill" style="background: #1EB9A7;">Selengkapnya</button></a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
    ...
    <div class="container-xl" style="position:relative;">
        ...
        <div class="row row-cols-lg-3 m-auto row-cols-xl-4 w-100">
            <!-- foreach disini -->
